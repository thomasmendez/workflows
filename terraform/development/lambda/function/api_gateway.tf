# Everything works but duplicate api gateway is made
# Issue: https://github.com/hashicorp/terraform-provider-aws/issues/14661
# Also: https://github.com/hashicorp/terraform-provider-aws/issues/11344
